...
type PushChatResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PushChatResponse) Reset() {
	*x = PushChatResponse{}
...
func (x *PushChatResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PushChatResponse) ProtoMessage() {}

func (x *PushChatResponse) ProtoReflect() protoreflect.Message {
	mi := &file_push_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use PushChatResponse.ProtoReflect.Descriptor instead.
func (*PushChatResponse) Descriptor() ([]byte, []int) {
...
const file_push_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"push.proto\x12\akubeapi\"\x12\n" +
	"\x10PushChatResponse2O\n" +
	"\vPushService\x12@\n" +
	"\bPushChat\x12\x19.kubeapi.PushChatResponse\x1a\x19.kubeapi.PushChatResponseB\fZ\n" +
	"./;kubeapib\x06proto3"
...
var file_push_proto_goTypes = []any{
	(*PushChatResponse)(nil), // 0: kubeapi.PushChatResponse
}
var file_push_proto_depIdxs = []int32{
	0, // 0: kubeapi.PushService.PushChat:input_type -> kubeapi.PushChatResponse
	0, // 1: kubeapi.PushService.PushChat:output_type -> kubeapi.PushChatResponse
