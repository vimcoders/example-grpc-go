...
const (
	HelloService_Echo_FullMethodName = "/kubeapi.HelloService/Echo"
)
...
func (UnimplementedHelloServiceServer) Echo(context.Context, *HelloRequest) (*HelloResponse, error) {
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kubeapi.HelloService",
